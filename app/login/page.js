...
const Login = () => {
    return (
        <div>
            <h1 className='text-amber-50 text-4xl'>Login to fund your favorite creators and get exclusive content!</h1>
            <div className='flex flex-col justify-center mt-5'>
                <div class="flex flex-col w-100 gap-2 justify-center items-center mx-auto">
                    ...
                    <button type="button" class="py-2 px-4 flex justify-center items-center bg-blue-700 hover:bg-blue-800 focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                        <svg class="mr-2" width="20" height="20" fill="currentColor" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button type="button" class="py-2 px-4 flex justify-center items-center bg-black hover:bg-neutral-900 focus:ring-gray-500 focus:ring-offset-gray-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                        <svg class="mr-2" width="20" height="20" fill="currentColor" viewBox="0 0 512 462.799" xmlns="http://www.w3.org/2000/svg">
